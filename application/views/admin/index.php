...
<head>
  ...
  <title>sambadi &mdash; Admin Login</title>
  <!-- plugins:css -->
      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
              ...
              <?= form_open("admin/index") ?>
                ...
                <div class="form-group">
                  <button class="btn btn-block g-login">
                    <img class="mr-3" src="<?= base_url() ?>assets/img/file-icons/icon-google.svg" alt="">Log in with Google</button>
                </div>
            ...
            <p class="footer-text text-center">&copy; sambadi 2018</p>
          </div>
        </div>
      </div>
